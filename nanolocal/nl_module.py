...
#   File "./nl_run.py", line 159, in <module>
#     main()
#   File "./nl_run.py", line 91, in main
#     nl_run.run_command("status")
#   File "/home/gr0vity/Documents/git/nano-speed-testsuite/nanolocal/nl_module.py", line 428, in run_command
#     self.network_status()
#   File "/home/gr0vity/Documents/git/nano-speed-testsuite/nanolocal/nl_module.py", line 347, in network_status
#     self.is_rpc_available(_conf.get_nodes_name(), wait=False)
#   File "/home/gr0vity/Documents/git/nano-speed-testsuite/nanolocal/nl_module.py", line 188, in is_rpc_available
#    self.subprocess_read_lines(cmd_rpc_url)[0:1][0]).strip()
...
class nl_runner():
    ...
    def __init__(self, runid="default", loglevel="INFO"):
        _conf.set_prom_runid(runid)
        self.runid = runid
