...
#PRE_GENERATE_BLOCKS
    ...
    def fund_bucket(self, bucket, source_seed, destination_index):       
        ...
        return self.bg.blockgen_single_account_opener(destination["account"], source["private"],destination_seed,  2**bucket, None, destination_index=destination_index, nano_rpc_all=self.nano_rpc_all[1] )
